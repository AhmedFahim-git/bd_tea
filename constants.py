...
GENDER_PARITY_DICT: dict[str, tuple[str, str]] = {
    "Inernet_15 year+ Gender Parity": (
        "Inernet_Female_15 year+",
        "Inernet_Male_15 year+",
    ),
    ...
    "Employment_Rate Gender Parity": ("Employment_Rate_Female", "Employment_Rate_Male"),
    "Have financial account Gender Parity": (
        "Have financial account_Female",
        "Have financial account_Male",
    ),
...
USD_BDT_EXCHANGE_RATE_2025 = (
    121.82  # From https://www.exchange-rates.org/exchange-rate-history/usd-bdt-2025
)
...
COLOR_MAP = {
    ...
    "Monthly_income": "RdYlGn",
    "Data_Cost_perc_income": "RdYlGn_r",
...
COL_NAME_MAP = {
    ...
    "Mobile Phone_15 year+ Gender Parity": "Gender Parity of 15+ population having Mobile Phone (in %)",
    ...
    "Inernet_15 year+ Gender Parity": "Gender Parity of 15+ population using Internet (in %)",
    ...
    "Literacy Rate_7year+ Gender Parity": "Gender Parity of Literacy Rate of Age 7+ (in %)",
    ...
    "Employment_Rate Gender Parity": "Gender Parity of Employment Rate (in %)",
    ...
    "Have financial account Gender Parity": "Gender Parity of population having Financial Account (in %)",
    ...
    "Mobile Bank Account Gender Parity": "Gender Parity of population having Moblie Bank Account (in %)",
    ...
    "Monthly_income": "Average Monthly Income (in BDT)",
    "Num_Income_Samples": "Number of Samples in Average Monthly Income Calculation",
    "Data_Cost_perc_income": "Price of 5GB Mobile Data as % of Monthly Income",
